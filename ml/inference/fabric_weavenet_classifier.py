...
class FabricWeaveNetClassifier:
...
if __name__ == "__main__":
    classifier = FabricWeaveNetClassifier()
    print("FabricWeaveNetClassifier initialized successfully.")
    print(f"Loaded {len(classifier.classes)} weave classes: {classifier.classes}")
