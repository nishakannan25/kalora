...
class PotteryCementPotsClassifier:
...
if __name__ == "__main__":
    classifier = PotteryCementPotsClassifier()
    print("PotteryCementPotsClassifier initialized successfully.")
    print(f"Loaded {len(classifier.classes)} cement classes: {classifier.classes}")
