"""
KALORA — Furniture & Woodcraft Classifier Inference Module
Model: MobileNetV3-Small (Pretrained ImageNet)
Categories: 6 Furniture & Woodcraft Craft/Product Classes
"""
...
MODEL_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "models", "furniture_woodcraft")
CONFIG_PATH = os.path.join(MODEL_DIR, "config.json")
WEIGHTS_PATH = os.path.join(MODEL_DIR, "best_model.pth")

CONFIDENCE_THRESHOLD = 0.60

class FurnitureWoodcraftClassifier:
...
if __name__ == "__main__":
    classifier = FurnitureWoodcraftClassifier()
    print("Furniture & Woodcraft Classifier Loaded Successfully.")
