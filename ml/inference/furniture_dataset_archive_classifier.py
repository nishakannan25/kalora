"""
KALORA — Furniture Dataset Archive Classifier Inference Module
Model: MobileNetV3-Small (Pretrained ImageNet)
Dataset: Uploaded Furniture Archive Dataset (15,000 images, 5 classes)
...
MODEL_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "models", "furniture_dataset_archive")
CONFIG_PATH = os.path.join(MODEL_DIR, "config.json")
WEIGHTS_PATH = os.path.join(MODEL_DIR, "best_model.pth")

CONFIDENCE_THRESHOLD = 0.60

class FurnitureDatasetArchiveClassifier:
...
if __name__ == "__main__":
    classifier = FurnitureDatasetArchiveClassifier()
    print("Furniture Dataset Archive Classifier Loaded Successfully.")
