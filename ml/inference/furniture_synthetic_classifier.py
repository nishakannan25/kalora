"""
KALORA — Furniture Synthetic Dataset Classifier Inference Module
Model: MobileNetV3-Small (Pretrained ImageNet)
Source: HuggingFace filnow/furniture-synthetic-dataset
Categories: 4 Main Furniture Classes (Bed, Chair, Sofa, Table)
Data Note: Trained on synthetic images; evaluated on real images.
...
MODEL_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "models", "furniture_synthetic")
CONFIG_PATH = os.path.join(MODEL_DIR, "config.json")
WEIGHTS_PATH = os.path.join(MODEL_DIR, "best_model.pth")

CONFIDENCE_THRESHOLD = 0.60

class FurnitureSyntheticClassifier:
...
if __name__ == "__main__":
    classifier = FurnitureSyntheticClassifier()
    print("Furniture Synthetic Classifier Loaded Successfully.")
