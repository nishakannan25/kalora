...
class PotteryClayPotsClassifier:
...
if __name__ == "__main__":
    classifier = PotteryClayPotsClassifier()
    print("PotteryClayPotsClassifier initialized successfully.")
    print(f"Loaded {len(classifier.classes)} clay classes: {classifier.classes}")
