...
class PotteryPlasticPotsClassifier:
...
if __name__ == "__main__":
    classifier = PotteryPlasticPotsClassifier()
    print("PotteryPlasticPotsClassifier initialized successfully.")
    print(f"Loaded {len(classifier.classes)} plastic classes: {classifier.classes}")
